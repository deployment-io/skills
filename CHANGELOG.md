...
- New "Creating Tasks (AI coding-agent PRs)" section in `SKILL.md` — prerequisites (non-SaaS runner, Anthropic credentials, repos with write scope), cost-awareness guidance, parameter detection for `create_task`, polling cadence (15s), and terminal-state interpretation (Succeeded / NoChanges / Failed / Cancelled).
